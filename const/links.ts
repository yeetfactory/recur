...
const APP_STORE_URL_IOS = normalize(process.env.EXPO_PUBLIC_APP_STORE_URL);
const PLAY_STORE_URL_ANDROID = normalize(process.env.EXPO_PUBLIC_PLAY_STORE_URL);
const APP_WEBSITE_URL = normalize(process.env.EXPO_PUBLIC_APP_WEBSITE_URL);
